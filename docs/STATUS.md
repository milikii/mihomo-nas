...
- 本轮验证结果：focused `go test ./internal/app -run 'TestApplyRules(SkipsTransparentRulesForExplicitProxyOnlyConfig|PropagatesExplicitProxyOnlyClearRulesFailure)'` 与全量 `go test ./...` 通过。
