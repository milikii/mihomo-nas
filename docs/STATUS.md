...
- 本轮验证结果：focused `go test ./internal/app -run 'Test(AddSubscriptionRejectsEmptyNameOrURLBeforePersisting|AddSubscriptionUpdatesExistingURLInPlace|UpdateSubscriptionsRecordsInvalidURLFailure)'` 与全量 `go test ./...` 通过。
