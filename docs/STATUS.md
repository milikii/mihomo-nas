...
- 本轮验证结果：focused `go test ./internal/runtime -run 'TestBuildRuntimeConfig(ReturnsRuleReadError|AppendsDefaultRuleTail|UsesDirectOnlyProxyGroupWithoutProviders|PreservesRulesRenderOrder)'` 与全量 `go test ./...` 通过。
